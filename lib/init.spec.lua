return function()
    ...
    do
        ...
        function advanceTime(delta)
            delta = delta or (1.6666666666666665E-2)
    ...
    describe('Promise.new', function()
        ...
        it('should preserve stack traces of resolve-chained promises', function()
            ...
            expect(trace:find(
[[...Rejected because it was chained to the following Promise, which encountered an error:]])).to.be.ok()
        end)
...
[[...Rejected because it was chained to the following Promise, which encountered an error:]])).to.be.ok()
    ...
    describe('Promise:finally', function()
        ...
        it('should not consume rejections', function()
            ...
            Promise.reject(5):finally(function()
                return 42
    ...
    describe('Promise.all', function()
        ...
        it(
[[should wait for all promises to be resolved and return their values]], function(
        )
    ...
    describe('Promise.fold', function()
        it(
[[should return the initial value in a promise when the list is empty]], function(
        )
            local initialValue = {}
        ...
        it(
[[should always return a promise even if the list or reducer don't use them]], function(
        )
    ...
    describe('Promise.tap', function()
        it('should thread through values', function()
            ...
            Promise.resolve(1):andThen(function(v)
                return v + 1
            end):tap(function(v)
                first = v
        ...
        it('should chain onto promises', function()
            ...
            local promise = Promise.resolve(1):tap(function()
    ...
    describe('Promise.each', function()
        ...
        it(
[[should allow Promises to be in the list and wait when it gets to them]], function(
        )
            local innerResolve
            local innerPromise = Promise.new(function(resolve)
                innerResolve = resolve
            end)
            local promise = Promise.each({innerPromise}, function(value)
                return value * 2
            end)
        ...
        it(
[[should reject immediately if there's a cancelled Promise in the list initially]], function(
        )
